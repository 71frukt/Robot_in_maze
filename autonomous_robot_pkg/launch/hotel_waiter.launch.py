...
def generate_launch_description():
    ...
    hotel_path = os.path.join(get_package_share_directory('autonomous_robot_pkg'),'world','hotel','model.sdf')
    table_path = os.path.join(get_package_share_directory('autonomous_robot_pkg'),'models','table','model.sdf')
    ...
    actor_path = os.path.join(get_package_share_directory('autonomous_robot_pkg'),'models','actor','model.sdf')

    world_path = os.path.join(get_package_share_directory('autonomous_robot_pkg'),'world','hotel','empty_world.world')
